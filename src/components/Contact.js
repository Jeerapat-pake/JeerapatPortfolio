...
export default function Contact() {
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto  sm:flex-nowrap flex-wrap text-center">
        <div className="text-center mb-10">
          <MailIcon className="mx-auto inline-block w-10 mb-4 text-purple-700" />
        ...
        <div className="grid lg:grid-cols-2 md:grid-col-1 ">
          <div className=" bg-gray-900 rounded-md overflow-hidden  sm: p-10 flex items-end justify-start relative">
            <iframe
              ...
              src="https://www.google.com/maps/embed/v1/place?q=แป้นทองบล็อค&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
            />
            <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className="mt-1">
                  Panntong bloc 2/9 <br />
                  Soi Ngamwongwan 57 <br />
                  Lay Yao ,Jatujak <br />
                  Bangkok 10900
                </p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a className="text-indigo-400 leading-relaxed">
                  jeerapat.wu@gmail.com
                </a>
                <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                  PHONE
                </h2>
                <p className="leading-relaxed">086-360-0293</p>
              </div>
            </div>
          </div>
        ...
        >
          <h2 className="text-purple-700 sm:text-4xl text-3xl mb-1 font-medium title-font">
            Contact Me
          </h2>
